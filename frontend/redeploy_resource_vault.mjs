...
// Load from contracts/.env since that's where the master keys are
...
async function deploy() {
  ...
  // Adjusted path to point to contracts/out from frontend
  const artifact = JSON.parse(fs.readFileSync('../contracts/out/ResourceVault.sol/ResourceVault.json', 'utf8'));
